...
['Server_Vehicle_Spawn', {
	...
	if (_id IN ["WASTE","DELIVER","EXTERMY","KARTING","DMV"]) then
	{
		switch (_class) do
		{
			...
			case ("A3PL_P362_TowTruck"): {_veh setObjectTextureGlobal [0,"\A3PL_Textures\Peterbilt_TowTruck\DMV_TowTruck.paa"];};
			case ("A3PL_Mailtruck"):
			{
				if (_id == "EXTERMY") then
				{
