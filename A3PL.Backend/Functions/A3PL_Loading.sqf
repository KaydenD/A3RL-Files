...
['A3PL_Loading_Start', {
	[] spawn {
		...
		_format = "<t size='3' font='PuristaSemiBold' align='center' color='#B8B8B8'>VERSION 1.0.0.1</t>"
		+ "<br/><br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>New Coast Guard Base</t>"
		+ "<br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>New Coast Guard Textures</t>"
		+ "<br/>"		
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Player to Player Car Sales</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Car Paint and Material syncing</t>"
		+ "<br/>"			
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Gas Staion Fuel Saving</t>"
		+ "<br/>"			
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Sand Gathering</t>"
		+ "<br/>"
