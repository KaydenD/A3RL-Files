...
['A3PL_Loading_Start', {
	[] spawn {
		...
		_format = "<t size='3' font='PuristaSemiBold' align='center' color='#B8B8B8'>VERSION 1.0.0.3</t>"
		+ "<br/><br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Blackjack</t>"
		+ "<br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Gangs and Gang Areas</t>"
		+ "<br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>FIFR Medical Training</t>"
		+ "<br/>"		
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Phone key app</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Drug Effects</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Spike strips</t>"
		+ "<br/>"			
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>TP to DOC after the ankle tracker was removed</t>"
		+ "<br/>"		
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Phone bank transfer</t>"
		+ "<br/>"		
