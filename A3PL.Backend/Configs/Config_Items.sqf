...
[
	...
	//Daivd's things
	["waterbottle", "Bottle of water", 0.5, "A3PL_BottlePlastic_V2",0,true,true,true, true, true,"A3PL_Items_Thirst", [0,0,0], ""],
	["waterbottlempty", "Empty water bottle", 0.5, "A3PL_BottlePlastic_V2",0,true,true,true, true, true,"", [0,0,0], ""],
	["wood_barrier","inh",6,"A3PL_RoadBarrier",0,true,true,true,false,false,"", [0,0,0], ""],
	["plastic_barrier_small","inh",6,"A3PL_PlasticBarrier_01",0,true,true,true,false,false,"", [0,0,0], ""],
	["plastic_barrier_large","inh",6,"A3PL_PlasticBarrier_02",0,true,true,true,false,false,"", [0,0,0], ""],
	["jerrycan_empty","Empty Jerrycan",5,"A3PL_Jerrycan",-90,true,true,true,true,true,"", [0,0,0], ""],
	["SMG_Part_Stock","SMG Stock",8,"A3PL_Synthetic_Fiber",-90,true,true,true,false,false,"", [0,0,0], ""],
	["SMG_Part_Body","SMG Body",10,"A3PL_Synthetic_Fiber",-90,true,true,true,false,false,"", [0,0,0], ""],
	["SMG_Part_Grip","SMG Grip",5,"A3PL_Synthetic_Fiber",-90,true,true,true,false,false,"", [0,0,0], ""],
	["SMG_Part_Trigger","SMG Trigger",5,"A3PL_Synthetic_Fiber",-90,true,true,true,false,false,"", [0,0,0], ""],
	...
	["v_lockpick","Lockpick",0.1,"A3RL_Lockpick",180,true,true,true,true,true,"", [-0.05,0.08,0.1], ""],
	...
	["soupcup","Soup Cup", 0.1, "A3PL_MaggiiNoodle",0,true,true,true, true, true,"A3PL_Items_Food", [0,0,0], ""],
	["cookies","Chocolate Sandwich Cookies", 0.1, "A3PL_Timtams",0,true,true,true, true, true,"A3PL_Items_Food", [0,0,0], ""],
	["cereal", "Breakfast Cereal Biscuits", 0.2, "A3PL_WeetBix", 90, true, true, true, true, true, "A3PL_Items_Food", [0,0,0], ""],
	["bread", "Loaf Of Bread", 0.2, "A3PL_Bread", 90, true, true, true, true, true, "A3PL_Items_Food", [0,0,0], ""],
	...
	["weed_10g","Marijuana (10 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_15g","Marijuana (15 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_20g","Marijuana (20 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""], 
	["weed_25g","Marijuana (25 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_30g","Marijuana (30 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_35g","Marijuana (35 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_40g","Marijuana (40 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_45g","Marijuana (45 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_50g","Marijuana (50 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_55g","Marijuana (55 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_60g","Marijuana (60 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_65g","Marijuana (65 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_70g","Marijuana (70 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_75g","Marijuana (75 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_80g","Marijuana (80 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_85g","Marijuana (85 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_90g","Marijuana (90 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_95g","Marijuana (95 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	["weed_100g","Marijuana (100 grams)",1,"A3PL_MarijuanaBag",90,true,true,true, true, true,"A3PL_Drugs_Use", [0,0,0], ""],
	...
	//legal diamonds obtained from mining
	...
	//class - name - weight - itemClass - direction (when using) - canDrop - canGive - canUse - canPickup - enableSimulation - fnc - custom attach point - item desc
	...
	["burger_bun","Burger Bun",0.5,"A3PL_Burger_Bun",0,true,true,true,true,true,"A3PL_Items_Food", [0,0,0], ""],// Get from Wheat
	["burger_burnt","Burnt Fish Patty",0.5,"A3PL_Burger_Burnt",0,true,true,true,true,true,"A3PL_Items_Food", [0,0,0], ""],//
	["burger_raw","Raw Fish Patty (mcfishers)",0.5,"A3PL_Burger_Raw",90,true,true,true,true,true,"A3PL_Items_Food", [0,0,0], ""],// Need recipes
	...
	["tacoshell","Taco Shell",1,"A3PL_TacoShell",0,true,true,true,true,true,"A3PL_Items_Food", [0,0,0], ""],// Need recipe Corn
	...
	["FD_Hose","Hose Rolled",4,"A3PL_FD_HoseRolled",90,true,true,true,true,true,"", [0,0,0], ""],
	["FD_HydrantWrench","Hydrant Wrench",3,"A3PL_FD_HydrantWrench",0,true,true,true, true, true,"", [0,0,0], ""],
	["FD_Mask","Oxygen Mask",2,"A3PL_FD_Mask_Obj",180,true,true,true, true, true,"", [-0.12,-0.15,-0.73], ""], //[-0.05,0,-0.58]
	...
	["Synthetic_Fibre","inh",0.2,"A3PL_Synthetic_Fiber",0,true,true,true,true,true,"", [0,0,0], ""], //A3PL_DeliveryBox
	...
	["Polyester","inh",1,"A3PL_Polyester",0,true,true,true,true,true,"", [0,0,0], ""], //A3PL_DeliveryBox
	...
	//["Tools_Maintenance","inh",15,"Jonzie_ToolsMaintenance",0,true,true,true,true,true,"", [0,0,0], ""],
	...
	//["Jaws_of_Life","inh",15,"Jonzie_JawsofLife",0,true,true,true,true,true,"", [0,0,0], ""],
	...
	//new Blueprints
	["Blueprint_SMG","SMG Blueprint",0,"A3PL_File2",0,true,true,true,true,true,"", [0,0,0], ""],
	["Blueprint_Attachment","Attachment Blueprint",0,"A3PL_File2",0,true,true,true,true,true,"", [0,0,0], ""],
	["Blueprint_Pistol_Legal","Legal Pistol Blueprint",0,"A3PL_File2",0,true,true,true,true,true,"", [0,0,0], ""],
	["Blueprint_Pistol_Legal_Ammo","Legal Pistol Ammo Blueprint",0,"A3PL_File2",0,true,true,true,true,true,"", [0,0,0], ""],
	["Blueprint_Glock","Glock 17 Blueprint",0,"A3PL_File2",0,true,true,true,true,true,"", [0,0,0], ""],
...
[
	...
	["police",
		["Weapons",
			//"Blueprint_A3PL_Taser",
			//"Blueprint_ACPC2",
			//"Blueprint_Rook40",
			//"Blueprint_MX_Blk"
		],
		["Magazines",
			//"Blueprint_A3PL_TaserMag",
			//"Blueprint_9Rnd_45ACP_Mag",
			//"Blueprint_30Rnd_9x21_Mag",
			//"Blueprint_30Rnd_65x39_caseless_mag",
			//	"Blueprint_30Rnd_65x39_caseless_mag_Tracer"
		],
		["Hats",
			//"Blueprint_Sheriff_Hat",
			//"Blueprint_Sheriff_Cap"
		],
		["Uniforms",
			//"Blueprint_Sheriff_Uniform",
			//"Blueprint_Rangemaster_belt_blk",
			//"Blueprint_TacVestIR_blk"
		],
		["Vehicles",
			//"Blueprint_cvpi_PD",
			//"Blueprint_cvpi_PDST",
			//"Blueprint_tahoe_PD",
			//"Blueprint_tahoe_PDST",
			//"Blueprint_mustang_PD",
			//"Blueprint_mustang_PDST",
			//"Blueprint_charger_PD",
			//"Blueprint_charger_PDST"
		],
		["Items",
			//"Blueprint_Handcuffs",
			//"Blueprint_Spikestrip"
		],
		["Attachments",
			//"Blueprint_Holosight_blk",
			//"Blueprint_Holosight",
			//"Blueprint_flashlight",
			//"Blueprint_bipod_01_F_blk"
		]
	],
	["FIFR",
		["Equipment",
			//"Blueprint_FD_yAdapter",
			//"Blueprint_FD_HydrantWrench",
			//"Blueprint_FD_Mask",
			//"Blueprint_FD_FireNozzle",
			//"Blueprint_FD_Helmet",
			//"Blueprint_FD_Oxygen"
		],
		["Uniform",
            //"Blueprint_FIFR_Uniform"
		],
		["Vehicles",
			//"Blueprint_tahoe_FD",
			//"Blueprint_ladder",
	...
	["uscg",
		...
		["Magazines",
			//"Blueprint_A3PL_TaserMag",
			//"Blueprint_11Rnd_45ACP_Mag",
			//"Blueprint_30Rnd_65x39_caseless_mag",
			//"Blueprint_30Rnd_65x39_caseless_mag_Tracer",
			//"Blueprint_20Rnd_762x51_Mag",
			//"Blueprint_30Rnd_556x45_Stanag_Green",
            //"Blueprint_30Rnd_556x45_Stanag_Red",
            //"Blueprint_30Rnd_556x45_Stanag_Yellow"
		...
		["Hats",
			//"Blueprint_USCG_Hat_Logo",
			//"Blueprint_USCG_Hat_Logo_Text",
			//"Blueprint_USCG_Hat_Text",
			//"Blueprint_USCG_Crew_Helmet"
		],
		["Vehicles",
			//"Blueprint_RBM",
			//"Blueprint_Boat_Civil_01_rescue",
			//"Blueprint_Goose",
			//"Blueprint_Jayhawk"
			//"Blueprint_cvpi_PD",
			//"Blueprint_cvpi_PDST",
...
//Zoffsets for placement
Config_Items_ZOffset =
[
//david's stuff

	["Land_BottlePlastic_V2_F",0.02],
	["A3PL_RoadBarrier",0.5],
	["A3PL_PlasticBarrier_01",0.3],
	["A3PL_PlasticBarrier_02",0.5],
	["A3PL_Suitcase",0.25],
	...
	//Gamer Perk
	["A3PL_Gamer_Dartboard",0.7,2],

	//Garden Perk
	["A3PL_Garden_VinesLarge",0.7,1.2],
	["A3PL_Garden_VinesMedium",0.7,1.1],
	["A3PL_Garden_VinesSmall",0.7,0.9],

	//Mancave Perk
	["A3PL_Mancave_Bearhead",0.7,2],
	["A3PL_Mancave_DeerAntlers",0.7,1.7],
	["A3PL_Mancave_FoxHead",0.7,2],
	["A3PL_Mancave_MooseHead",0.7,2],
	["A3PL_Mancave_Wolfhead",0.7,2],
	["A3PL_Mancave_CocktailSign",0.7,1.6],
	["A3PL_Mancave_GhostbusterSign",0.7,1.6],

	//Walldecor Perk
	["A3PL_WallDecor_WallPanel1",0.7,2],
	["A3PL_WallDecor_WallPanel2",0.7,2],
	["A3PL_WallDecor_WallPanel3",0.7,2],
	["A3PL_WallDecor_WallPanel4",0.7,2],
	["A3PL_WallDecor_WallPanel5",0.7,2],
	["A3PL_WallDecor_WallPanel6",0.7,2],
	["A3PL_WallDecor_WallPanel7",0.7,2],
	["A3PL_WallDecor_WallPanel8",0.7,2],
	["A3PL_WallDecor_WallPanel9",0.7,2],
	["A3PL_WallDecor_WallPanel10",0.7,2],
	["A3PL_WallDecor_WallPanel11",0.7,2],
	["A3PL_WallDecor_WallPanel12",0.7,2],
	["A3PL_WallDecor_WallPanel13",0.7,2],
	["A3PL_WallDecor_WallPanel14",0.7,2],
	["A3PL_WallDecor_WallPanel15",0.7,1.85]
];
publicVariable "Config_Items_ZOffset";

Config_Food =
[
	//class - quality (amount of hunger it satisifies)
	["donut", 2],
	["apple",2],
...
Config_Placeables = ["GroundWeaponHolder","RoadCone_F","A3PL_Spikes_Closed","A3PL_Spikes_Open","A3PL_Ski_Base","A3PL_RoadBarrier","A3PL_PlasticBarrier_01","A3PL_PlasticBarrier_02"];
Config_Furniture = ["A3PL_Bed1","A3PL_Bed2","A3PL_Cabinet1","A3PL_Cabinet2","A3PL_Cabinet3","A3PL_Chair1"];

//Add Config_Furniture to Config_Placeable
{
