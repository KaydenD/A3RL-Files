["A3RL_Slots_Roll", 
{
	...
	while{_delayLeft > 0} do {
		_box1Roll = _icons selectRandomWeighted [5,9,12,1,18];
		_box2Roll = _icons selectRandomWeighted [5,9,12,1,18];
		_box3Roll = _icons selectRandomWeighted [5,9,12,1,18];
	...
	switch(true) do {
		...
		case(_box1Roll IN ["cherry","bell","seven"] && _box2Roll IN ["cherry","bell","seven"] && _box3Roll IN ["cherry","bell","seven"]): {_multi = 2;};
	};
