...
[
	...
	*/
	...
	["Spine3","Grab","\a3\ui_f\data\IGUI\RscIngameUI\RscUnitInfoAirRTDFull\ico_insp_hand_1_ca.paa",{(isPlayer player_objintersect)&& ((player getVariable "job") IN ["police","uscg","usms"]) && (surfaceIsWater position player)}], //Drag
	["Spine1","Grab","\a3\ui_f\data\IGUI\RscIngameUI\RscUnitInfoAirRTDFull\ico_insp_hand_1_ca.paa",{(isPlayer player_objintersect)&& ((player getVariable "job") IN ["police","uscg","usms"]) && (surfaceIsWater position player)}], //Drag
