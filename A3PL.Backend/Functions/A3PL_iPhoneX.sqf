...
["A3PL_iPhoneX_AddPhoneNumberSecondary",
{
	...
	if(!([] call A3PL_Player_AntiSpam)) exitWith {};
	if (!(["motorhead"] call A3PL_Lib_hasPerk)) exitWith {["You need to have motorhead perk for buy secondary subscription! www.arma3projectlife.com",Color_Red] call A3PL_Player_Notification;};
