...
['A3PL_Loading_Start', {
	[] spawn {
		...
		_format = "<t size='3' font='PuristaSemiBold' align='center' color='#B8B8B8'>VERSION 1.0.0.2</t>"
		+ "<br/><br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Slot Machines</t>"
		+ "<br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Port Robberies</t>"
		+ "<br/>"
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>House Robberies</t>"
		+ "<br/>"		
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Mini-Exacvator Rental</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Knock Out</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>New Phone UI</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Added: </t><t size='1' align='left'>Virtual Items in Patdown</t>"
		+ "<br/>"	
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>Walk through walls on expensive houses</t>"
		+ "<br/>"			
		+ "<t size='1' align='left' color='#00ff00'> Fixed: </t><t size='1' align='left'>AD shows phone number</t>"
		+ "<br/>"		
